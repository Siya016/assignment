...
//       from: 'MinuitesAI <no-reply@minutesai.com>', // Use Resend's default sender for testing
//       to: emailData.to,
...
export async function sendSummaryEmail(emailData: EmailData) {
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: 'siyaagh44@gmail.com', // your Gmail address
    ...
    const mailOptions = {
      from: `"Minutes AI" <siyaagh44@gmail.com>`, // Friendly name + Gmail address
